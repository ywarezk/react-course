// rxjs
import {Observable, Observer, Subscription, Subject, BehaviorSubject, interval, from, of} from 'rxjs';
...
// 0 .. 1 .. 2 .. 3
const myIntervalObservableOperator : Observable<number> = interval(1000);
